class AMoment {
    static definition = {
        ...
        attributes: {
            ...
            analysis: {type: 'json', description: 'Optional analysis results.'}
        },
        associations: {
            scenario: {
                type: 'AScenario',
                description: 'Owning scenario.',
                cardinality: 1,
                composition: false,
                owner: false,
                via: 'moments'
            ...
            actor: {
                type: 'AActor',
                description: 'Actor in which the user is operating.',
                cardinality: 1,
                composition: false,
                owner: false
            },
            identity: {
                type: 'AIdentity',
                description: 'User who generated this moment.',
                cardinality: 1,
                composition: false,
                owner: false
            },
            feedback: {
                type: 'AFeedback',
                description: 'Explicit/implicit feedback on this moment.',
                cardinality: 'n',
                composition: true,
                owner: true,
                via: 'moment'
