...
module.exports = {
    ...
    inputs: {
        ...
        extends: {
            type: "Array",
            description: "List of use cases that this use case extends if any. Do not set if there aren't any",
            required: false,
        },
        includes: {
            type: "Array",
            description: "List of use cases that this use case includes. Do not set if there aren't any",
            required: false,
        },
        actors: {
            type: "Array",
