...
module.exports = {
    friendlyName: 'save',
    description: 'Save the network device to disk',
    static: false,
    inputs: {},
    outputs: {
        type: "AComputeDevice",
    ...
    fn: function (obj, inputs, env) {
        ...
        const baseDir = obj.dir || global.ailtire.config.baseDir + '/physical/environments/' + obj.environment.name + '/networkDevices/';
