...
describe('actor set', () => {
  ...
  test('should execute successfully with valid inputs', () => {
    ...
    const result = execSync(`node bin/ailtire actor set --id test-id --summary optionalValue --document optionalValue`);
  ...
  test('should fail if id is missing or invalid', () => {
    ...
    expect(() => {
      execSync(`node bin/ailtire actor set --missingKey`);
    }).toThrow();
  });
