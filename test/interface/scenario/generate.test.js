...
describe('scenario generate', () => {

  test('should execute successfully with valid inputs', () => {

    // Run the command and test outputs
    const result = execSync(`node bin/ailtire scenario generate --id test-id --target test-target`);
  ...
  test('should fail if id is missing or invalid', () => {
    ...
    expect(() => {
      execSync(`node bin/ailtire scenario generate --missingKey`);
    }).toThrow();
  });
