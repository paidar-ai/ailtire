...
describe('scenario get', () => {
  ...
  test('should execute successfully with valid inputs', () => {
    ...
    const result = execSync(`node bin/ailtire scenario get --id test-id --doc optionalValue`);
  ...
  test('should fail if id is missing or invalid', () => {
    ...
    expect(() => {
      execSync(`node bin/ailtire scenario get --missingKey`);
    }).toThrow();
  });
