...
describe('usecase generate', () => {

  test('should execute successfully with valid inputs', () => {

    // Run the command and test outputs
    const result = execSync(`node bin/ailtire usecase generate --id test-id --target test-target`);
  ...
  test('should fail if id is missing or invalid', () => {
    ...
    expect(() => {
      execSync(`node bin/ailtire usecase generate --missingKey`);
    }).toThrow();
  });
